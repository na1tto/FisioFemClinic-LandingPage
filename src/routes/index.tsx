...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      {
        title: "FisioFemClinic — Fisioterapia Obstétrica em Marabá",
      },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "FisioFemClinic" },
      {
        ...
        content: "Fisioterapia obstétrica com cuidado individualizado para gestantes e puérperas.",
      },
          ...
          <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-6">
              ...
              <h1 className="mt-6 max-w-[20ch] font-serif text-5xl font-medium leading-tight tracking-tight text-ink text-balance lg:text-6xl">
                FisioFem: Onde o cuidado com o seu corpo encontra o amor da sua maternidade
              </h1>
              <p className="mt-6 max-w-[48ch] text-base leading-relaxed text-ink/70 text-pretty lg:text-lg">
                Cuidamos da sua pelve e do seu corpo com a delicadeza que o seu momento pede.
                Acompanhamento individual para gestantes e puérperas, em um espaço pensado para
                você.
              </p>
            ...
            <div className="relative lg:col-span-6">
              ...
              <div className="relative z-10">
                ...
                <div className="absolute -bottom-6 left-4 flex items-center gap-3 rounded-[1.75rem] bg-white/70 px-5 py-4 ring-1 ring-ink/5 lg:left-8">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-ink">+1.200 gestantes</p>
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            <div className="rounded-[2rem] bg-creme p-8 ring-1 ring-ink/5 transition-transform duration-300 hover:-translate-y-1.5">
              ...
              <p className="mt-3 text-sm leading-relaxed text-ink/70">
                Alívio de desconfortos, fortalecimento e preparação segura para o parto com sessões
                individualizadas.
              </p>
              <a
                href="#contato"
            ...
            <div className="rounded-[2rem] bg-creme p-8 ring-1 ring-ink/5 transition-transform duration-300 hover:-translate-y-1.5">
              ...
              <p className="mt-3 text-sm leading-relaxed text-ink/70">
                Movimentos suaves que sustentam a coluna ao longo da gravidez e aceleram a
            ...
            <div className="rounded-[2rem] bg-creme p-8 ring-1 ring-ink/5 transition-transform duration-300 hover:-translate-y-1.5">
              ...
              <h3 className="mt-5 font-serif text-2xl font-semibold text-ink">Recursos manuais</h3>
              <p className="mt-3 text-sm leading-relaxed text-ink/70">
                Massagem relaxante e drenagem linfática para reduzir inchaço, tensões e o peso do
                dia a dia.
              </p>
              <a
                href="#contato"
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-10 lg:py-24">
          <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-14">
            ...
            <div className="order-1 lg:order-2 lg:col-span-6">
              ...
              <p className="mt-6 max-w-[48ch] text-base leading-relaxed text-ink/70 text-pretty lg:text-lg">
                Cada avaliação começa com uma conversa longa. Ajustamos cada sessão ao seu
                trimestre, à sua história e ao que seu corpo está pedindo naquele dia.
              </p>
              <ul className="mt-8 space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-ink/75">
                    <strong className="font-semibold text-ink">Plano no seu ritmo</strong> —
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-10 lg:py-24">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 max-w-[48ch] text-base leading-relaxed text-white/80 text-pretty">
              Valores acessíveis, com opções avulsas, ciclos, pacotes e planos mensais para
          ...
          <div className="mt-8 grid items-stretch gap-5 md:grid-cols-2">
            <article className="flex flex-col rounded-[2rem] bg-creme/95 p-8 ring-1 ring-white/40">
              ...
              <dl className="mt-6 flex-1 divide-y divide-ink/10 text-sm text-ink/75">
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Sessão avulsa</dt>
                  <dd className="font-semibold text-ink">R$ 350,00</dd>
                </div>
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Ciclo de 4 sessões</dt>
                  <dd className="font-semibold text-ink">R$ 1.380,00</dd>
                </div>
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Ciclo de 8 sessões</dt>
                  <dd className="font-semibold text-ink">R$ 2.720,00</dd>
                </div>
              </dl>
              <a
                href="#contato"
            ...
            <article className="flex flex-col rounded-[2rem] bg-ink p-8 ring-1 ring-ink">
              ...
              <h3 className="mt-2 font-serif text-2xl font-semibold text-creme">
                Pilates para gestantes e puérperas
              </h3>
              <dl className="mt-6 flex-1 divide-y divide-creme/15 text-sm text-creme/80">
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Aula avulsa</dt>
                  <dd className="font-semibold text-creme">R$ 110,00</dd>
                </div>
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>1 aula por semana</dt>
                  <dd className="font-semibold text-creme">R$ 420,00/mês</dd>
                </div>
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>2 aulas por semana</dt>
                  <dd className="font-semibold text-creme">R$ 830,00/mês</dd>
                </div>
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>3 aulas por semana</dt>
                  <dd className="font-semibold text-creme">R$ 1.230,00/mês</dd>
                </div>
              </dl>
              <a
                href="#contato"
            ...
            <article className="flex flex-col rounded-[2rem] bg-creme/95 p-8 ring-1 ring-white/40">
              ...
              <h3 className="mt-2 font-serif text-2xl font-semibold text-ink">
                Drenagem linfática materna
              </h3>
              <dl className="mt-6 flex-1 divide-y divide-ink/10 text-sm text-ink/75">
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Sessão avulsa</dt>
                  <dd className="font-semibold text-ink">R$ 160,00</dd>
                </div>
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Pacote com 5 sessões</dt>
                  <dd className="font-semibold text-ink">R$ 750,00</dd>
                </div>
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Pacote com 10 sessões</dt>
                  <dd className="font-semibold text-ink">R$ 1.400,00</dd>
                </div>
              </dl>
              <a
                href="#contato"
            ...
            <article className="flex flex-col rounded-[2rem] bg-creme/95 p-8 ring-1 ring-white/40">
              ...
              <h3 className="mt-2 font-serif text-2xl font-semibold text-ink">
                Terapia manual relaxante
              </h3>
              <dl className="mt-6 flex-1 divide-y divide-ink/10 text-sm text-ink/75">
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Sessão avulsa</dt>
                  <dd className="font-semibold text-ink">R$ 180,00</dd>
                </div>
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Pacote com 4 sessões</dt>
                  <dd className="font-semibold text-ink">R$ 700,00</dd>
                </div>
                <div className="flex items-center justify-between gap-4 py-3">
                  <dt>Pacote com 8 sessões</dt>
                  <dd className="font-semibold text-ink">R$ 1.360,00</dd>
                </div>
              </dl>
              <a
                href="#contato"
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            <figure className="rounded-[2rem] bg-creme p-8 ring-1 ring-ink/5">
              <p className="font-serif text-lg leading-relaxed text-ink">
                "Cheguei com muito medo do parto. Saí entendendo meu corpo e sabendo exatamente o
                que esperar."
              </p>
              <figcaption className="mt-6 border-t border-ink/10 pt-4">
                <p className="text-sm font-semibold text-ink">Mariana S.</p>
                <p className="text-xs text-ink/55">Gestante no 3º trimestre</p>
              </figcaption>
            </figure>
            <figure className="rounded-[2rem] bg-creme p-8 ring-1 ring-ink/5">
              <p className="font-serif text-lg leading-relaxed text-ink">
                "A drenagem mudou minha semana. Voltei a me reconhecer no espelho depois do
                pós-parto."
              </p>
              <figcaption className="mt-6 border-t border-ink/10 pt-4">
            ...
            <figure className="rounded-[2rem] bg-creme p-8 ring-1 ring-ink/5">
              <p className="font-serif text-lg leading-relaxed text-ink">
                "Cada sessão parecia feita só para mim. Nunca me senti tão cuidada em uma clínica."
              </p>
              <figcaption className="mt-6 border-t border-ink/10 pt-4">
                <p className="text-sm font-semibold text-ink">Beatriz L.</p>
                <p className="text-xs text-ink/55">Gestante no 2º trimestre</p>
              </figcaption>
            </figure>
          </div>
        </div>
          ...
          <div className="grid gap-10 rounded-[2.5rem] bg-nude p-8 ring-1 ring-ink/5 lg:grid-cols-2 lg:p-12">
            <div>
              ...
              <p className="mt-5 max-w-[42ch] text-ink/70">
                Preencha seus dados e escolha o serviço que faz sentido para o seu momento.
            ...
            <form onSubmit={handleSubmit} className="rounded-[2rem] bg-creme p-8 ring-1 ring-ink/5">
              {formStatus === "sent" ? (
                <div className="flex flex-col items-center justify-center py-10 text-center">
                  ...
                  <p className="mt-2 max-w-[32ch] text-sm text-ink/70">
                    Nossa equipe vai entrar em contato em breve para combinar os próximos passos.
                  </p>
                </div>
              ) : (
                <>
      ...
      <footer className="bg-ink text-creme">
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-10">
          ...
          <div className="mt-12 flex flex-col items-start justify-between gap-3 border-t border-creme/15 pt-6 text-xs text-creme/50 sm:flex-row sm:items-center">
            <span>© 2026 FisioFemClinic. Todos os direitos reservados.</span>
